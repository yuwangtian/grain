...
<div class="col-lg-4 col-lg-offset-4" >
    <div class="wrapper-page">
        <div class="m-t-30 card-box">
            <form class="form-signin" id="addUserFrom" name="addUserFrom" role="form" method="post" action="/addSait.do?user_id=${userBo.user_id}">
                <div class="error-box">${msg}</div>
                <input hidden id="groupId" value="${groupId}">
                <input hidden id="type" value="saits">
                <input hidden id="user_id" value="${userBo.user_id}">
                <input class="form-control" name="shoujin_time" required autofocus  maxlength="10" id="shoujin_time" type="text"  placeholder="受浸日期" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})">
                <div style="height: 10px"></div>
                <input class="form-control" placeholder="昵称"   id="name" name="name" >
                <div style="height: 10px"></div>
