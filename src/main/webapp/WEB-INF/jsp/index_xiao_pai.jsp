...
<div class="container-fluid main-content">
    <table class="grain_table" border="1">
        ...
        <tr style="background-color: #f8efc0">
            ...
            <td>人数</td>
            <td>
                <c:if test="${seesionGroupBo.group_level==40}">
                    操作
                </c:if>
            </td>
        </tr>
        ...
        <tr style="background-color: #f8efc0">
            ...
            <td>
                <c:if test="${seesionGroupBo.group_level==40}">
                    <a href="/operate.do?groupId=${groupId}&type=new_saits_total_num">增加</a>
                </c:if>
            </td>
        </tr>
        <tr style="background-color: #f8efc0">
            ...
            <td>
                <c:if test="${seesionGroupBo.group_level==40}">
                    <a href="/operate.do?groupId=${groupId}&type=friends_num">增加</a>
                </c:if>
            </td>
        </tr>
        <tr style="background-color: #f8efc0">
            ...
            <td>
                <c:if test="${seesionGroupBo.group_level==40}">
                    <a href="/operate.do?groupId=${groupId}&type=saits_total_num">增加</a>
                </c:if>
            </td>
        </tr>
    ...
    <c:forEach items="${childGroupNumBoList}" var="childGroupNum" varStatus="stat">
        <table class="grain_table" border="1">
            ...
            <tr style="background-color: #f8efc0">
                ...
                <td>
                    <c:if test="${seesionGroupBo.group_level==40}">
                    <a href="/operate.do?groupId=${childGroupNum.group_id}&type=new_saits_total_num">增加</a>
                    </c:if>
                </td>
            </tr>
            <tr style="background-color: #f8efc0">
                ...
                <td>
                    <c:if test="${seesionGroupBo.group_level==40}">
                    <a href="/operate.do?groupId=${childGroupNum.group_id}&type=friends_num">增加</a>
                   </c:if>
                </td>
            </tr>
            <tr style="background-color: #f8efc0">
                ...
                <td>
                    <c:if test="${seesionGroupBo.group_level==40}">
                    <a href="/operate.do?groupId=${childGroupNum.group_id}&type=saits_total_num">增加</a>
                    </c:if>
                </td>
            </tr>
